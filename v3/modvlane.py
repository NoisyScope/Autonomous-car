...
class Lane:
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([
      (179,222), # Top-left corner
      (0,300), # Bottom-left corner			
      (630,300), # Bottom-right corner
      (436,222) # Top-right corner
    ])
    ...
    self.YM_PER_PIX = 0.8 / 77 # meters per pixel in y dimension
    self.XM_PER_PIX = 0.6 / 600 # meters per pixel in x dimension
